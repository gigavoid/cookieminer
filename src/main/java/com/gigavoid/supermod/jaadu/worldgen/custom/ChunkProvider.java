...
import com.gigavoid.supermod.jaadu.biome.JaaduBiomeGenBase;
...
public class ChunkProvider implements IChunkProvider {
    ...
    /** RNG. */
    private Random rand;
    private NoiseGeneratorOctaves noiseGenBottom1;
    private NoiseGeneratorOctaves noiseGenBottom2;
    private NoiseGeneratorOctaves noiseGenBottom3;
    private NoiseGeneratorPerlin noiseGenPerlinBottom;
    /** A NoiseGeneratorOctaves used in generating terrain */
    public NoiseGeneratorOctaves noiseGenBottom5;
    /** A NoiseGeneratorOctaves used in generating terrain */
    public NoiseGeneratorOctaves noiseGenBottom6;
    ...
    public ChunkProvider(World worldIn, long p_i45636_2_, boolean p_i45636_4_, String p_i45636_5_)
    {
        ...
        this.noiseGenBottom1 = new NoiseGeneratorOctaves(this.rand, 16);
        this.noiseGenBottom2 = new NoiseGeneratorOctaves(this.rand, 16);
        this.noiseGenBottom3 = new NoiseGeneratorOctaves(this.rand, 8);
        this.noiseGenPerlinBottom = new NoiseGeneratorPerlin(this.rand, 4);
        this.noiseGenBottom5 = new NoiseGeneratorOctaves(this.rand, 10);
        this.noiseGenBottom6 = new NoiseGeneratorOctaves(this.rand, 16);
        ...
        if (p_i45636_5_ != null)
        {
            ...
            this.oceanFiller = this.chunkProviderSettings.field_177778_E ? Blocks.obsidian : Blocks.water;
        }

        NoiseGenerator[] noiseGens = {noiseGenBottom1, noiseGenBottom2, noiseGenBottom3, noiseGenPerlinBottom, noiseGenBottom5, noiseGenBottom6, mobSpawnerNoise};
        noiseGens = TerrainGen.getModdedNoiseGenerators(worldIn, this.rand, noiseGens);
        this.noiseGenBottom1 = (NoiseGeneratorOctaves)noiseGens[0];
        this.noiseGenBottom2 = (NoiseGeneratorOctaves)noiseGens[1];
        this.noiseGenBottom3 = (NoiseGeneratorOctaves)noiseGens[2];
        this.noiseGenPerlinBottom = (NoiseGeneratorPerlin)noiseGens[3];
        this.noiseGenBottom5 = (NoiseGeneratorOctaves)noiseGens[4];
        this.noiseGenBottom6 = (NoiseGeneratorOctaves)noiseGens[5];
                ...
                for (int k2 = 0; k2 < 32; ++k2)
                {
                    ...
                    for (int l2 = 0; l2 < 8; ++l2)
                    {
                        ...
                        for (int i3 = 0; i3 < 4; ++i3)
                        {
                            ...
                            {
                                if ((d15 += d16) > 0.0D && k2 * 8 + l2 - 40 >= 0)
                                {
                                    p_180518_3_.setBlockState(k * 4 + i3, k2 * 8 + l2 - 40, j1 * 4 + j3, Blocks.stone.getDefaultState());
                                }
    ...
    public void func_180517_a(int p_180517_1_, int p_180517_2_, ChunkPrimer p_180517_3_, BiomeGenBase[] p_180517_4_)
    {
        ...
        double d0 = 0.03125D;
        this.stoneNoise = this.noiseGenPerlinBottom.func_151599_a(this.stoneNoise, (double)(p_180517_1_ * 16), (double)(p_180517_2_ * 16), 16, 16, d0 * 2.0D, d0 * 2.0D, 1.0D);

        for (int k = 0; k < 16; ++k)
        {
            for (int l = 0; l < 16; ++l)
            {
                JaaduBiomeGenBase biomegenbase = new JaaduBiomeGenBase(55);
                        //p_180517_4_[l + k * 16];
    ...
    {
        this.field_147426_g = this.noiseGenBottom6.generateNoiseOctaves(this.field_147426_g, p_147423_1_, p_147423_3_, 5, 5, (double)this.chunkProviderSettings.field_177808_e, (double)this.chunkProviderSettings.field_177803_f, (double)this.chunkProviderSettings.field_177804_g);
        float f = this.chunkProviderSettings.field_177811_a;
        float f1 = this.chunkProviderSettings.field_177809_b;
        this.field_147427_d = this.noiseGenBottom3.generateNoiseOctaves(this.field_147427_d, p_147423_1_, p_147423_2_, p_147423_3_, 5, 33, 5, (double)(f / this.chunkProviderSettings.field_177825_h), (double)(f1 / this.chunkProviderSettings.field_177827_i), (double)(f / this.chunkProviderSettings.field_177821_j));
        this.field_147428_e = this.noiseGenBottom1.generateNoiseOctaves(this.field_147428_e, p_147423_1_, p_147423_2_, p_147423_3_, 5, 33, 5, (double)f, (double)f1, (double)f);
        this.field_147425_f = this.noiseGenBottom2.generateNoiseOctaves(this.field_147425_f, p_147423_1_, p_147423_2_, p_147423_3_, 5, 33, 5, (double)f, (double)f1, (double)f);
        int l = 0;
        int i1 = 0;
