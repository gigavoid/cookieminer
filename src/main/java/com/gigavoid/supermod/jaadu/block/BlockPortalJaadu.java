...
import com.gigavoid.supermod.jaadu.teleporter.Teleporter;
...
public class BlockPortalJaadu extends BlockPortal {
    public BlockPortalJaadu() {
        super();
    ...
    public void onEntityCollidedWithBlock(World worldIn, BlockPos pos, IBlockState state, Entity entityIn) {
       // public void onEntityCollidedWithBlock(World par1World, int par2, int par3, int par4, Entity par5Entity) {
            if ((entityIn.ridingEntity == null) && (entityIn.riddenByEntity == null) && ((entityIn instanceof EntityPlayerMP))) {
                ...
                } else if (player.dimension != ModuleJaadu.dimensionId) {
                    player.timeUntilPortal = 10;

                    player.mcServer.getConfigurationManager().transferPlayerToDimension(player, ModuleJaadu.dimensionId, new Teleporter(mServer.worldServerForDimension(ModuleJaadu.dimensionId)));
                } else {
                    player.timeUntilPortal = 10;
    ...
    public static class Size {
        ...
        protected int func_150858_a() {
            ...
            for (this.field_150862_g = 0; this.field_150862_g < 21; ++this.field_150862_g) {
                for (i = 0; i < this.field_150868_h; ++i) {
                    ...
                    if (block == JaaduBlocks.jaaduPortal) {
                        ++this.field_150864_e;
                    }
        ...
        protected boolean func_150857_a(Block p_150857_1_) {
            ...
            return material == Material.air || p_150857_1_ == Blocks.fire || p_150857_1_ == JaaduBlocks.jaaduPortal;
        }
        ...
        public void func_150859_c() {
            for (int i = 0; i < this.field_150868_h; ++i) {
                ...
                for (int j = 0; j < this.field_150862_g; ++j) {
                    this.field_150867_a.setBlockState(blockpos.offsetUp(j), JaaduBlocks.jaaduPortal.getDefaultState().withProperty(BlockPortalJaadu.field_176550_a, this.field_150865_b), 2);
                }
            }
        }
    }
