...
public class TeleporterNorthrend extends Teleporter
{
    ...
    public TeleporterNorthrend(WorldServer par1WorldServer)
    {
        ...
        else
        {
            for (k1 = l - short1; k1 <= l + short1; ++k1)
            {
                ...
                for (int l1 = i1 - short1; l1 <= i1 + short1; ++l1)
                {
                    ...
                    {
                        if (this.worldServerInstance.getBlock(k1, i2, l1) == SuperBlocks.portalNorthrend)
                        {
                            while (this.worldServerInstance.getBlock(k1, i2 - 1, l1) == SuperBlocks.portalNorthrend)
                            {
                                --i2;
                            }
