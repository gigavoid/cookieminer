...
import com.gigavoid.supermod.cookiecraft.renderer.layer.LayerCookiecreeper;
...
public class RenderCookiecreeper extends RenderLiving {
    ...
    public RenderCookiecreeper(RenderManager p_i46186_1_)
    {
        super(p_i46186_1_, new ModelCreeper(), 0.5F);
        this.addLayer(new LayerCookiecreeper(this));
    }
