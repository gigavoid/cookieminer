package com.gigavoid.supermod.cookiecraft.renderer.layer;

import com.gigavoid.supermod.cookiecraft.renderer.RenderCookiecreeper;
...
public class LayerCookiecreeper implements LayerRenderer {
    private static final ResourceLocation LIGHTNING_TEXTURE = new ResourceLocation("textures/entity/creeper/creeper_armor.png");
    private final RenderCookiecreeper creeperRenderer;
    private final ModelCreeper creeperModel = new ModelCreeper(2.0F);
    private static final String __OBFID = "CL_00002423";

    public LayerCookiecreeper(RenderCookiecreeper p_i46121_1_)
    {
