...
/**
 * Created by Lukas on 2015-02-17.
 */
public class ItemPickaxeShovel extends ItemTool {
    ...
    public boolean canHarvestBlock(Block blockIn)
    {
        ...
        boolean canHarvestWithShovel = blockIn == Blocks.snow_layer || blockIn == Blocks.snow;
        return canHarvestWithPick || canHarvestWithShovel;
    }
