...
import com.gigavoid.supermod.northrend.teleporter.NorthrendTeleporter;
       ...
       // public void onEntityCollidedWithBlock(World par1World, int par2, int par3, int par4, Entity par5Entity) {
            if ((entityIn.ridingEntity == null) && (entityIn.riddenByEntity == null) && ((entityIn instanceof EntityPlayerMP))) {
                ...
                if (player.timeUntilPortal > 0) {
                    ...
                    player.mcServer.getConfigurationManager().transferPlayerToDimension(player, ModuleNorthrend.dimensionId, new NorthrendTeleporter(mServer.worldServerForDimension(ModuleNorthrend.dimensionId)));
                } else {
                    player.timeUntilPortal = 10;
                    player.mcServer.getConfigurationManager().transferPlayerToDimension(player, 0, new NorthrendTeleporter(mServer.worldServerForDimension(0)));
                }
            }
    }
