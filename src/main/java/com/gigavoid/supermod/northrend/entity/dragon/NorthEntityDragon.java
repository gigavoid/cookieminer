package com.gigavoid.supermod.northrend.entity.dragon;
...
public class NorthEntityDragon extends EntityLiving implements IEntityMultiPart, IMob {
    ...
    public NorthEntityDragon(World world) {
        super(world);
    ...
    private void collideWithEntities(List p_70970_1_) {
        ...
        for (Object aP_70970_1_ : p_70970_1_) {
            Entity entity = (Entity) aP_70970_1_;
    ...
    /**
     * Kills the entity, called by the /kill command
     */
