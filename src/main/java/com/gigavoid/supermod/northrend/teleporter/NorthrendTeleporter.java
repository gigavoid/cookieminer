...
import com.gigavoid.supermod.northrend.block.BlockNorthPortal;
...
public class NorthrendTeleporter extends net.minecraft.world.Teleporter
{
    ...
    public NorthrendTeleporter(WorldServer worldServer) {
        super(worldServer);
    ...
    public boolean func_180620_b(Entity p_180620_1_, float p_180620_2_)
    {
        ...
        {
            NorthrendTeleporter.PortalPosition portalposition = (NorthrendTeleporter.PortalPosition)this.destinationCoordinateCache.getValueByKey(k);
            d0 = 0.0D;
        ...
        if (d0 >= 0.0D)
        {
            if (flag1)
            {
                this.destinationCoordinateCache.add(k, new NorthrendTeleporter.PortalPosition((BlockPos)object, this.worldServerInstance.getTotalWorldTime()));
    ...
    public void removeStalePortalLocations(long p_85189_1_)
    {
        if (p_85189_1_ % 100L == 0L)
        {
            ...
            while (iterator.hasNext())
            {
                ...
                NorthrendTeleporter.PortalPosition portalposition = (NorthrendTeleporter.PortalPosition)this.destinationCoordinateCache.getValueByKey(olong.longValue());
