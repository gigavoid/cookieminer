...
public class NorthrendBiomes {
    ...
    public static final BiomeGenNorthGlacier northGlacier = new BiomeGenNorthGlacier(44, 30);
    ...
    public static final BiomeGenNorthRockyGlacier northRockyGlacier = new BiomeGenNorthRockyGlacier(51, 30);
    ...
    public static void registerBiomes(){
        ...
        BiomeManager.addBiome(BiomeManager.BiomeType.ICY, new BiomeManager.BiomeEntry(northRockyGlacier, 0));
    }
}
