...
public class NorthrendMapGenMineshaft extends MapGenStructure
{
    private double field_82673_e = 0.004D;
    private static final String __OBFID = "CL_00000443";

    public NorthrendMapGenMineshaft() {}
    ...
    public NorthrendMapGenMineshaft(Map p_i2034_1_)
    {
    ...
    {
        return new NorthrendStructureMineshaftStart(this.worldObj, this.rand, p_75049_1_, p_75049_2_);
    }
}