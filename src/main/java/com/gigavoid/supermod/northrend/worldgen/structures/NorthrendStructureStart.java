...
public class NorthrendStructureStart extends StructureStart
{
    ...
    public NorthrendStructureStart() {}

    public NorthrendStructureStart(int p_i43002_1_, int p_i43002_2_)
    {
    ...
    public void generateStructure(World worldIn, Random p_75068_2_, StructureBoundingBox p_75068_3_)
    {
        ...
        {
            NorthrendStructureComponent structurecomponent = (NorthrendStructureComponent)iterator.next();
