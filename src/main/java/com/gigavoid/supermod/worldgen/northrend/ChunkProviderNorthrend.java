...
public class ChunkProviderNorthrend implements IChunkProvider
{
    ...
    public ChunkProviderNorthrend(World worldIn, long p_i45636_2_, boolean p_i45636_4_, String p_i45636_5_)
    {
        this.field_177476_s = Blocks.water;
        this.stoneNoise = new double[256];
        this.caveGenerator = new MapGenCavesNorthrend();
        this.strongholdGenerator = new MapGenStrongholdNorthrend();
        this.villageGenerator = new MapGenVillageNorthrend();
        this.mineshaftGenerator = new MapGenMineshaft();
        this.scatteredFeatureGenerator = new MapGenScatteredFeature();
        this.ravineGenerator = new MapGenRavineNorthrend();
