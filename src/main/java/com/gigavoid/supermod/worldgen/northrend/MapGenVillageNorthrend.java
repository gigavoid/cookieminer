...
public class MapGenVillageNorthrend extends MapGenVillage
{
    ...
    public static List northVillageSpawnBiomes = Arrays.asList(new BiomeGenBase[]{SuperBiomes.northPlains});
    ...
    public MapGenVillageNorthrend(Map p_i2093_1_)
    {
        this();
    ...
    protected boolean canSpawnStructureAtCoords(int p_75047_1_, int p_75047_2_)
    {
        ...
        if (k == i1 && l == j1)
        {
            boolean flag = this.worldObj.getWorldChunkManager().areBiomesViable(k * 16 + 8, l * 16 + 8, 0, northVillageSpawnBiomes);
    ...
    {
        return new MapGenVillageNorthrend.Start(this.worldObj, this.rand, p_75049_1_, p_75049_2_, this.terrainType);
    }
