...
/**
 * Created by Rasmus on 2014-10-25.
 */
public class SuperWorldGenTrees extends WorldGenTrees {
    ...
    public SuperWorldGenTrees(boolean p_i2028_1_, int p_i2028_2_, int p_i2028_4_, boolean p_i2028_5_)
    {
        super(p_i2028_1_);
            ...
            else
            {
                ...
                if (isSoil && p_76484_4_ < 256 - l - 1)
                {
                    ...
                    for (k1 = 0; k1 < l; ++k1)
                    {
                        ...
                        {
                            this.setBlockAndNotifyAdequately(p_76484_1_, p_76484_3_, p_76484_4_ + k1, p_76484_5_, SuperBlocks.emeraldLog, 0);
