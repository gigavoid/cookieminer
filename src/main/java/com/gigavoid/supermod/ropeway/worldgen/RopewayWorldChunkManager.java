...
{
    public static ArrayList<RopewayBiomeGenBase> allowedBiomes = Lists.newArrayList((RopewayBiomeGenBase)RopewayBiomes.skylands, (RopewayBiomeGenBase)RopewayBiomes.skylands2);
    ...
    protected RopewayWorldChunkManager()
    {
    ...
    public RopewayWorldChunkManager(long p_i45744_1_, WorldType p_i45744_3_, String p_i45744_4_)
    {
        this();
        this.field_180301_f = p_i45744_4_;
        GenLayer[] agenlayer = RopewayGenLayerBiome.func_180781_a(p_i45744_1_);
        this.genBiomes = agenlayer[0];
        this.biomeIndexLayer = agenlayer[1];
    }

    public RopewayWorldChunkManager(World worldIn)
    {
