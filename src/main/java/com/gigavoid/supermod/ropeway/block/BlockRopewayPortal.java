...
import com.gigavoid.supermod.ropeway.teleporter.RopewayTeleporter;
...
public class BlockRopewayPortal extends BlockBreakable {
    ...
    public void onEntityCollidedWithBlock(World worldIn, BlockPos pos, IBlockState state, Entity entityIn) {
       // public void onEntityCollidedWithBlock(World par1World, int par2, int par3, int par4, Entity par5Entity) {
            if ((entityIn.ridingEntity == null) && (entityIn.riddenByEntity == null) && ((entityIn instanceof EntityPlayerMP))) {
                ...
                } else if (player.dimension != ModuleRopeway.dimensionId) {
                    player.timeUntilPortal = 10;

                    player.mcServer.getConfigurationManager().transferPlayerToDimension(player, ModuleRopeway.dimensionId, new RopewayTeleporter(mServer.worldServerForDimension(ModuleRopeway.dimensionId)));
                } else {
                    player.timeUntilPortal = 10;
                    player.mcServer.getConfigurationManager().transferPlayerToDimension(player, 0, new RopewayTeleporter(mServer.worldServerForDimension(0)));
                }
            }
    }
    ...
    public static class Size {
        ...
        protected int func_180120_a(BlockPos p_180120_1_, EnumFacing p_180120_2_) {
            ...
            for (i = 0; i < 22; ++i) {
                ...
                if (!this.func_150857_a(this.field_150867_a.getBlockState(blockpos1).getBlock()) || this.field_150867_a.getBlockState(blockpos1.offsetDown()).getBlock() != Blocks.quartz_block) {
                    break;
                }
            }
        ...
        protected int func_150858_a() {
            ...
            for (this.field_150862_g = 0; this.field_150862_g < 21; ++this.field_150862_g) {
                for (i = 0; i < this.field_150868_h; ++i) {
                    ...
                    if (block == RopewayBlocks.portalRopeway) {
                        ++this.field_150864_e;
                    }
            ...
            for (i = 0; i < this.field_150868_h; ++i) {
                if (this.field_150867_a.getBlockState(this.field_150861_f.offset(this.field_150866_c, i).offsetUp(this.field_150862_g)).getBlock() != Blocks.quartz_block) {
        ...
        protected boolean func_150857_a(Block p_150857_1_) {
            ...
            return material == Material.air || p_150857_1_ == Blocks.fire || p_150857_1_ == RopewayBlocks.portalRopeway;
        }
        ...
        public void func_150859_c() {
            for (int i = 0; i < this.field_150868_h; ++i) {
                ...
                for (int j = 0; j < this.field_150862_g; ++j) {
                    this.field_150867_a.setBlockState(blockpos.offsetUp(j), RopewayBlocks.portalRopeway.getDefaultState().withProperty(BlockRopewayPortal.field_176550_a, this.field_150865_b), 2);
                }
            }
        }
    }
